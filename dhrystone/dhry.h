...
/*******************************************************************************
 * PRINTF Implementation for Internal Logging
 *
 * All output for this bare-metal port goes through ee_printf() (see
 * barebones/ee_printf.c), which drives the V4H HSCIF UART directly.
 ******************************************************************************/

#define PRINTF  ee_printf
#define NOTICE  ee_printf
#define INFO    ee_printf
#define ERROR   ee_printf

/* Number of Dhrystone loops. 300000 is enough to keep User_Time above
   Too_Small_Time (2s) at ~130kHz timer resolution; adjust if needed. */
#define NUMBER_OF_RUNS 300000
#define CORE_FREQ_MHz 533
...
typedef int Arr_1_Dim[20];  /* Reduced from 50 to 20 */
typedef int Arr_2_Dim[20][20];  /* Reduced from 50x50 to 20x20 */
